...
\begin{flushleft}
    \begin{tabbing}
    \hspace{4cm} \= \kill
    1. Introducción \> \dotfill 1 \\
    2. Fundamentos \> \dotfill 3 \\
    3. Metodología \> \dotfill 7 \\
    \hspace{0.5cm}3.1 Diseño \> \dotfill 8 \\
    \hspace{0.5cm}3.2 Implementación \> \dotfill 12 \\
    4. Resultados \> \dotfill 18 \\
    5. Conclusiones \> \dotfill 22 \\
    \end{tabbing}
    \end{flushleft}
