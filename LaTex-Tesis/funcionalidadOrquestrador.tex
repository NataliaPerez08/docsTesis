...
Registro de un usuario que se identificará por un nombre, email y una contraseña que el orquestador se encargará de guardar y validar para permitir al usuario gestionar sus redes.


\begin{verbatim}
    python3 main.py login_user <email> <password>
\end{verbatim}

Identificación y autorización del usuario que gestionara sus redes.

\begin{verbatim}
    python3 main.py whoami
\end{verbatim}

Regresa al usuario actual.
